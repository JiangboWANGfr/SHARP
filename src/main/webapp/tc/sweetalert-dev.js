...
exports['default'] = sweetAlert = swal = function () {
  ...
  switch (typeof customizations) {
    ...
    case 'object':
      ...
      params.confirmButtonText1 = params.showCancelButton ? 'Confirm' : _defaultParams2['default'].confirmButtonText1;
      params.confirmButtonText1 = argumentOrDefault('confirmButtonText1');
...
var setParameters = function setParameters(params) {
  ...
  if (params.confirmButtonText1) {
    $confirmBtn.innerHTML = _hasClass$addClass$removeClass$escapeHtml$_show$show$_hide$hide.escapeHtml(params.confirmButtonText1);
  }
